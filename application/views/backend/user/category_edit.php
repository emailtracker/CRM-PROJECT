      ...
      <div class="card-body">
        <div class="col-lg-12">
          ...
          <form class="required-form" action="<?php echo site_url('admin/categories/edit/'.$category_id); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
               <label for="course_url_code"><?php echo get_phrase('course_url_code'); ?><span class="required">*</span></label>
                <input type="text" class="form-control" id="course_url_code" name="course_url_code" placeholder="<?php echo get_phrase('enter_course_url_code'); ?>" value="<?php echo $category_details['course_url_code']; ?>">
            </div>
