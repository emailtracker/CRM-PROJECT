...
<?php
$website_review_details = $this->review_model->get_website_review_by_id($website_review_id)->row_array();
?>
<div class="row ">
    <div class="col-xl-12">
        <div class="card">
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="required-form" action="<?php echo site_url('review/website_review/update/'.$website_review_id); ?>" enctype="multipart/form-data" method="post">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" id="first_name" value="<?php echo $website_review_details['first_name']; ?>" name="first_name" required>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" ><?php echo get_phrase('last_name'); ?></label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" id="last_name" value="<?php echo $website_review_details['last_name']; ?>" name="last_name">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="linkedin_link"><?php echo get_phrase('biography'); ?></label>
                                            <div class="col-md-9">
                                                <textarea name="biography" id = "summernote-basic" class="form-control"><?php echo $website_review_details['biography']; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <img src="<?php echo base_url().'/uploads/review/website_review/profile_image/'.$website_review_details['profile_image'];?>" alt="user-image" height="50" class="shadow-sm">
                                            </div>
                                        </div>
                                    </div> <!-- end col -->
                                </div> <!-- end row -->
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="facebook_link" name="facebook_link" value="<?php echo $website_review_details['facebook']; ?>" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="twitter_link"><?php echo get_phrase('twitter'); ?></label>
                                            <div class="col-md-9">
                                                <input type="text" id="twitter_link" name="twitter_link" value="<?php echo $website_review_details['twitter']; ?>" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="linkedin_link"><?php echo get_phrase('linkedin'); ?></label>
                                            <div class="col-md-9">
                                                <input type="text" id="linkedin_link" name="linkedin_link" value="<?php echo $website_review_details['linkedin']; ?>" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="instagram_link"><?php echo get_phrase('instagram'); ?></label>
                                            <div class="col-md-9">
                                                <input type="text" id="instagram_link" name="instagram_link" value="<?php echo $website_review_details['instagram']; ?>" class="form-control">
                                            </div>
                                        </div>
                                    </div> <!-- end col -->
                                </div> <!-- end row -->
				                    ...
				                    <div class="form-group">
						    			...
						    			<select class="form-control select2" data-toggle="select2" name="country_id" id="country_id">
						    				...
						    				<?php foreach($this->custom_model->get_country()->result_array() as $country): ?>
						    					<option value="<?php echo $country['c_id']; ?>" <?php if($country['c_id'] == $website_review_details['country_id'])echo 'selected'; ?>><?php echo $country['c_name']; ?></option>
						    				<?php endforeach; ?>
						    			</select>
						    		</div>
						    		...
						    		<div class="form-group">
						    			...
						    			<select class="form-control select2" data-toggle="select2" name="city_id" id="city_id">
						    				...
						    				<?php foreach($this->custom_model->get_city()->result_array() as $city): ?>
						    					<option value="<?php echo $city['cc_id']; ?>" <?php if($city['cc_id'] == $website_review_details['city_id'])echo 'selected'; ?>><?php echo $city['cc_name']; ?></option>
						    				<?php endforeach; ?>
						    			</select>
						    		</div>
						    		<div class="form-group">
                                            ...
                                            <div class="">
                                                <input type="text" class="form-control" value="<?php echo $website_review_details['rating']; ?>" id="rating" name="rating">
                                            </div>
                                        </div>
						    		<div class="form-group">
                                            <label><?php echo get_phrase('review'); ?></label>
                                            <div>
                                                <textarea name="comment" id = "review_comment" class="form-control"><?php echo $website_review_details['comment']; ?></textarea>
                                            </div>
                                        </div>
                                         <div class="form-group">
					                        <label for="parent"><?php echo get_phrase('Review_status'); ?></label>
					                         <select class="form-control select2" data-toggle="select2" name="status" id="review_status">
					                              <option value="1" <?php if ($website_review_details['status'] == 1) echo 'selected'; ?>>Enable</option>
                              					  <option value="0" <?php if ($website_review_details['status'] == 0) echo 'selected'; ?>>Disable</option>
					                        </select>
					                    </div>
                                    </div> <!-- end col -->
                                    <div class="col-3"></div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <div class="">
                                                    <select class="form-control select2" data-toggle="select2" name="video_type" id="course_overview_provider">
                                                    	<option value="youtube" <?php if ($website_review_details['video_type'] == 'youtube') echo 'selected'; ?>><?php echo get_phrase('youtube'); ?></option>
                                                    	<option value="vimeo" <?php if ($website_review_details['video_type'] == 'vimeo') echo 'selected'; ?>><?php echo get_phrase('vimeo'); ?></option>
                                                    	<option value="html5" <?php if ($website_review_details['video_type'] == 'html5') echo 'selected'; ?>><?php echo get_phrase('HTML5'); ?></option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="">
                                                    <input type="text" class="form-control" name="video_url" value="<?php echo $website_review_details['video_url']; ?>" id="video_url" placeholder="E.g: https://www.youtube.com/watch?v=oBtf8Yglw2w">
                                                </div>
                                            </div>
                                       <div class="form-group" id = "thumbnail-picker-area">
					                        ...
					                        <img src="<?php echo base_url().'/uploads/review/website_review/video_image/'.$website_review_details['review_video_image'];?>" alt="user-image" height="100" class="shadow-sm">
					                    </div>
                                    </div> 
                                     </div> <!-- end col -->
