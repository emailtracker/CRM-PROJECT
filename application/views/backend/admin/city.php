    ...
    <div class="card">
      <div class="card-body">
        <h4 class="page-title"> <i class="mdi mdi-web title_icon"></i> <?php echo get_phrase('city'); ?>
          <a href="<?php echo site_url('admin/city_form/add_city'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle mr-1"><i class="mdi mdi-plus"></i> <?php echo get_phrase('add_new_city'); ?></a>
        </h4>
      </div> <!-- end card body-->
    </div> <!-- end card -->
  </div><!-- end col-->
                  ...
                  <td>
                    <div class="dropright dropright">
                      ...
                      <ul class="dropdown-menu">
                        <a class="dropdown-item" href="<?php echo site_url('admin/city_form/edit_city/'.$ctry['cc_id']); ?>"><?php echo get_phrase('edit'); ?></a></li>

                        <li><a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('admin/city/delete/' . $ctry['cc_id']); ?>');"><?php echo get_phrase('delete'); ?></a></li>
                      </ul>
                    </div>
                  </td>
                </tr>
