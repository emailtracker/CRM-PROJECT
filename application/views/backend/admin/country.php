                  ...
                  <td>
                    <div class="dropright dropright">
                      ...
                      <ul class="dropdown-menu">
                        <a class="dropdown-item" href="<?php echo site_url('admin/country_form/edit_country/'.$ctry['c_id']); ?>"><?php echo get_phrase('edit'); ?></a></li>

                        <li><a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('admin/country/delete/' . $ctry['c_id']); ?>');"><?php echo get_phrase('delete'); ?></a></li>
                      </ul>
                    </div>
                  </td>
                </tr>
