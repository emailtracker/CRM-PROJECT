	...
	<div class="col-xl-12">
		<div class="card">
			<div class="card-body">
				...
				<a href="<?php echo site_url('Emailtemplate/email_form/add'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle mr-1"><i class="mdi mdi-plus"></i> <?php echo get_phrase('add_new_template'); ?></a>	
				</h4>
				...
				<div class="table-responsive-sm mt-4">
                    ...
                    <div class="dropright dropright">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('Emailtemplate/mailtemplate/delete/'.$templatenames['id'] ); ?>');"><?php echo get_phrase('delete'); ?></a></li>
                      </ul>
                    </div>
                  </td>
						</tr>
